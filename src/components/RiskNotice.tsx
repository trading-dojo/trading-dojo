      ...
      <VStack spacing={4} align="start" width="100%" maxWidth="800px">
        ...
        {isExpanded && (
          <>
            ...
            <Text fontSize="md" textAlign={"left"}>
              The Trading Dojo and its partners shall not be liable to you for any monetary losses or any other damages that you incur, directly or indirectly, of any kind or nature, from your use or reliance on any free information or paid training materials we may provide on this site and through the services generally. Any information contained on this site may be changed at any time without notice to you.
            </Text>
            <Text fontSize="md" textAlign={"left"}>
